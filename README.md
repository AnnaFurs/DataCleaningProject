...
* [Anna Fursova](https://github.com/AnnaFurs/DataCleaningProject)

## Выводы

В ходе работы над проектом была продемонстрирована техника очистки данных в том числе с помощью реализации модифицированных алгоритмов (алгоритм метода межквартильного размаха (метод Тьюки), метод z-отклонений (метод сигм)). 
